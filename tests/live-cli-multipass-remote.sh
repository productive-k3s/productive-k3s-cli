...
PROFILE_URL="${PK3S_CLI_MULTIPASS_PROFILE_URL:-https://raw.githubusercontent.com/jemacchi/productive-k3s-infra/main/profiles/multipass/1-server-2-agents.env}"
