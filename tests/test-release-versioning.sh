...
assert_eq "${PRODUCTIVE_K3S_GITHUB_OWNER_DEFAULT}" "jemacchi" "default github owner"
assert_eq "${PRODUCTIVE_K3S_GITHUB_BASE_URL_DEFAULT}" "https://github.com/jemacchi" "default github base url"
assert_eq "${PRODUCTIVE_K3S_GITHUB_RAW_BASE_URL_DEFAULT}" "https://raw.githubusercontent.com/jemacchi" "default github raw base url"
...
assert_eq "${PRODUCTIVE_K3S_INFRA_VERSION_DEFAULT}" "0.9.62-0.9.4" "default infra version"
