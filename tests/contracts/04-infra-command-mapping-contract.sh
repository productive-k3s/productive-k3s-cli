...
result = {
  ...
  "expected_mappings": {
    ...
    "pk3s profile export --tgz ./demo-profile.tgz --output ./bundle": "./productive-k3s-infra.sh profile export --tgz <file> --output <path>",
    "pk3s infra install --tgz ./demo-profile.tgz": "./productive-k3s-infra.sh profile install --tgz <file>",
    "pk3s infra export --tgz ./demo-profile.tgz --output ./bundle": "./productive-k3s-infra.sh profile export --tgz <file> --output <path>",
    ...
    "pk3s profile validate edge-arm": "./productive-k3s-infra.sh dev profile validate --profile-env <file>",
